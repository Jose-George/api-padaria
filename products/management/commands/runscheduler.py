...
from products.cron import verificar_produtos_vencidos
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Verifica produtos vencidos diariamente à meia-noite
        scheduler.add_job(
            verificar_produtos_vencidos,
            trigger=CronTrigger(second="*/5"),  # Executa a cada 5 segundos pata teste
            #trigger=CronTrigger(hour=0, minute=0)  # Todo dia à meia-noite
